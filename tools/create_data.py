...
from tools.dataset_converters import waterscenes_converter
...
def waterscenes_data_prep(root_path, info_prefix, out_dir):
    """Prepare the info file for WaterScenes dataset.
    ...
    Args:
        ...
        out_dir (str): Output directory of the generated info file.
    """
    waterscenes_converter.create_waterscenes_info_file(
...
def vod_data_prep(root_path,
    ...
    Args:
        ...
        with_plane (bool, optional): Whether to use plane information.
            Default: False.
    """
    vod.create_vod_info_file(root_path, info_prefix, with_plane)
...
if __name__ == '__main__':
    ...
    elif args.dataset == 'waterscenes':
        waterscenes_data_prep(
