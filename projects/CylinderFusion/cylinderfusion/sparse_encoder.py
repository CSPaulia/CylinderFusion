...
class BEVFusionSparseEncoder(SparseEncoder):
    ...
    def forward(self, voxel_features, coors, batch_size):
        ...
        # print(input_sp_tensor.indices.shape)
        ...
        # print('coords num:', out.indices.shape)
        ...
        if self.return_middle_feats:
            if self.return_sparse:
                ...
                return spatial_features, encode_features, None
        else:
            if self.return_sparse:
                return spatial_features, None, out
            else:
                return spatial_features, None, None
