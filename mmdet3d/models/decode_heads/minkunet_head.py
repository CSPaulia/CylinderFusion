...
class MinkUNetHead(Base3DDecodeHead):
    ...
    def __init__(self, 
        ...
        self.loss_lovasz = MODELS.build(
            loss_lovasz) if loss_lovasz is not None else None
    ...
    @property
    def with_lovasz(self):
        """bool: Whether the head has lovasz loss."""
        return hasattr(self, 'loss_lovasz') and self.loss_lovasz is not None
