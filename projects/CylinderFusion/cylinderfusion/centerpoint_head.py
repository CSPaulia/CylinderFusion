...
class CenterHeadKITTI(BaseModule):
    ...
    def __init__(self,
        ...
        self.task_specific = task_specific # here
    ...
    def get_targets_single(self,
        ...
        for idx, task_head in enumerate(self.task_heads):
            ...
            anno_box = gt_bboxes_3d.new_zeros((max_objs, 8), # here
                                              dtype=torch.float32)
    ...
    def loss_by_feat(self, preds_dicts: Tuple[List[dict]],
        ...
        for task_id, preds_dict in enumerate(preds_dicts):
            ...
            if self.task_specific: # here
                ...
                # print('pred', pred[0][1:5])
                # print('bbox', target_box[0][1:5])
    ...
    def predict_by_feat(self, preds_dicts: Tuple[List[dict]],
        ...
        for task_id, preds_dict in enumerate(preds_dicts):
            ...
            nms_type = self.test_cfg.get('nms_type') # here
            if isinstance(nms_type, list): # here
                nms_type = nms_type[task_id] # here
            if nms_type == 'circle': # here
                ret_task = []
