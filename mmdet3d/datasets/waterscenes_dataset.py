...
class WaterScenesDataset(Seg3DDataset):
    r"""WaterScenes Dataset.
    ...
    """
    METAINFO = {
        'classes': ('background', 'pier', 'buoy', 'sailor', 'ship', 'boat', 
                    'vessel', 'kayak'),
        'palette': [[255, 0, 0], [100, 150, 245], [100, 230, 245],
                    [100, 80, 250], [255, 40, 200], [255, 0, 255],
                    [75, 0, 75], [255, 200, 0]],
        'seg_valid_class_ids':
        tuple(range(8)),
        'seg_all_class_ids':
